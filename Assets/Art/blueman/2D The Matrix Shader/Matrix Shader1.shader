Shader "Custom/2D/MatrixGlyph_RainTint_1"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // ✅ Adjust glyph spacing with density
                ...
                // overlay color blend
                baseColor.rgb = lerp(baseColor.rgb, _OverlayColor.rgb, _OverlayStrength * _OverlayColor.a);
                ...
                // final color
                float3 colored = baseColor.rgb * (_Brightness * (1.0 + head * _HeadBoost)) * glyphA;

                return fixed4(colored, glyphA);
            }
            ENDHLSL
        }
    }
